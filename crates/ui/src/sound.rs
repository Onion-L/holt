...
//! - `HOLT_DISABLE_SOUND` env kill-switch + the `soundEnabled` ui-setting;
...
const DISABLE_ENV: &str = "HOLT_DISABLE_SOUND";
...
fn temp_path() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("holt-sound-{}-{id}.wav", std::process::id()))
}
