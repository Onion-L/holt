//! Syntax-highlighting contracts shared by Holt's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Holt preserves those structural roles separately.
