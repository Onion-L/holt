//! holt-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
//! Port of holt's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in holt, `oplog-shape.test.ts`): message parts are a
