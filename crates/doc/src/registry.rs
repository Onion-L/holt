...
use holt_proto::{Chat, ChatConfig, Device, Session, Space};
...
/// and the engine host drive it under a lock.
...
// ("idle"/"working"/…) — holt_proto's serde derives already use camelCase;
